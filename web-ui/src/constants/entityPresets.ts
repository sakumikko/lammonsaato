...
export const ENTITY_PRESETS: Record<string, EntityPreset> = {
  ...
  // Rolling integrals (calculated client-side from PID Sum)
  'virtual.pid_integral_15m': {
    entityId: 'virtual.pid_integral_15m',
    label: 'PID Integral 15m',
    color: COLORS.orange,
    minValue: -50,
    maxValue: 50,
    axisGroup: 'control',
  ...
  'virtual.pid_integral_30m': {
    entityId: 'virtual.pid_integral_30m',
    label: 'PID Integral 30m',
    color: COLORS.yellow,
    minValue: -100,
    maxValue: 100,
    axisGroup: 'control',
  ...
  'virtual.pid_integral_60m': {
    entityId: 'virtual.pid_integral_60m',
    label: 'PID Integral 60m',
    color: COLORS.green,
    minValue: -200,
    maxValue: 200,
    axisGroup: 'control',
